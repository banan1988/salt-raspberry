touchpad-driverDiagnosticPopUp-disable:
  cmd.run:
    - name: 'New-ItemProperty -Path "Microsoft.PowerShell.Core\Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SynTP\Parameters\Debug" -Name "DumpKernel" -PropertyType DWord -Value 0'
    - shell: powershell
...
keyboard-Hotkey-disable:
  cmd.run:
    - name: 'New-ItemProperty -Path "Microsoft.PowerShell.Core\Registry::HKEY_CURRENT_USER\Keyboard Layout\Toggle" -Name "Hotkey" -PropertyType String -Value 3'
    - shell: powershell
...
keyboard-LanguageHotkey-disable:
  cmd.run:
    - name: 'New-ItemProperty -Path "Microsoft.PowerShell.Core\Registry::HKEY_CURRENT_USER\Keyboard Layout\Toggle" -Name "Language Hotkey" -PropertyType String -Value 3'
    - shell: powershell
...
keyboard-LayoutHotkey-disable:
  cmd.run:
    - name: 'New-ItemProperty -Path "Microsoft.PowerShell.Core\Registry::HKEY_CURRENT_USER\Keyboard Layout\Toggle" -Name "Layout Hotkey" -PropertyType String -Value 3'
    - shell: powershell
